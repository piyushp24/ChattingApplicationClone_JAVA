...
public class Server implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        f.repaint();
        f.invalidate();
        f.validate();  // we do not need object to call these because they already are there defined in JFrame
    ...
    public static void main(String[] args) {
        new Server(); // anonymous object for direct constructor call
